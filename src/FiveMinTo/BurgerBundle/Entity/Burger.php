...
{
	/**
	 * @ORM\OneToOne(targetEntity="FiveMinTo\BurgerBundle\Entity\Burger")
	 */
	 private $vote;
     ...
     * @return Burger
     */
    public function setDateCreationBurger($dateCreationBurger)
    {
     ...
     * Set vote
     *
     * @param \FiveMinTo\BurgerBundle\Entity\Burger $vote
     * @return Burger
     */
    public function setVote(\FiveMinTo\BurgerBundle\Entity\Burger $vote = null)
    {
        $this->vote = $vote;
